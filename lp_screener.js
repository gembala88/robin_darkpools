...
async function evaluatePools() {
  ...
  for (const [key, po] of entries) {
    ...
    // Auto-open (Phase 2):
    // Gates: trend UP, score >= 25, HHI < 4000, GMGN clean, TVL >= $20k, governance OK
